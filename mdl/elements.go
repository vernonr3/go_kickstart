...
type (
	...
	Component struct {
		...
		// elements.
		Relationships []*Relationship `json:"relationships,omitempty"`
		// structs are one of two fundamentals that lie underneath a component aka package
		Structs []*Struct
		// interfaces are one of two fundamentals that lie underneath a component aka package
